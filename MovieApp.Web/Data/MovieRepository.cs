    ...
    public class MovieRepository
    {
        ...
        static MovieRepository()
        {
            _movies = new List<Movie>() {
                ...
                new Movie{MovieId=4, Title = "Film 4", Description= "Aciklama 4", Director="Yönetmen 4", Players=new string[] {"Oyuncu1", "Oyuncu2", "Oyuncu3"}, ImageUrl = "1.jpg"},
                new Movie{MovieId=5, Title = "Film 5", Description= "Aciklama 5", Director="Yönetmen 5", Players=new string[] {"Oyuncu1", "Oyuncu2", "Oyuncu3"}, ImageUrl = "2.jpg"},
                new Movie{MovieId=6, Title = "Film 6", Description= "Aciklama 6", Director="Yönetmen 6", Players=new string[] {"Oyuncu1", "Oyuncu2", "Oyuncu3"}, ImageUrl = "3.jpg"}
            };
        }
